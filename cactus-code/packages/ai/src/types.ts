...
export type KnownProvider = "cactus";
...
export interface AssistantMessage {
	...
	cloudHandoff?: boolean; // Cactus hybrid: true if this response was produced by the cloud model, false if local, undefined if unknown
	usage: Usage;
