...
export class DefaultPackageManager implements PackageManager {
	...
	private async installNpmBatch(_specs: string[], _scope: InstalledSourceScope): Promise<void> {
		throw new Error("Package installation is disabled in this Cactus build.");
	}
	...
	private async installNpm(_source: NpmSource, _scope: SourceScope, _temporary: boolean): Promise<void> {
		throw new Error("Package installation is disabled in this Cactus build.");
	}
	...
	private async installGit(_source: GitSource, _scope: SourceScope): Promise<void> {
		throw new Error("Package installation is disabled in this Cactus build.");
	}
