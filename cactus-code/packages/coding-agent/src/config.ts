...
export const APP_NAME: string = piConfigName || "cactus";
export const APP_TITLE: string = piConfigName || "cactus";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".cactus";

function readCactusVersion(): string | undefined {
	const pkgDir = getPackageDir();
	for (const rel of [
		["..", "..", "CACTUS_VERSION"], // bundled wheel: <code>/CACTUS_VERSION
		["..", "..", "..", "CACTUS_VERSION"], // dev checkout: <repo>/CACTUS_VERSION
	]) {
		try {
			const value = readFileSync(join(pkgDir, ...rel), "utf-8").trim();
...
export const VERSION: string = readCactusVersion() || pkg.version || "0.0.0";
...
// =============================================================================
// User Config Paths (~/.cactus/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.cactus/agent/) */
